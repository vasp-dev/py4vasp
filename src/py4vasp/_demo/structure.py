...
def SiC_fcc_disturbed():
    return raw.Structure(
        raw.Stoichiometry(number_ion_types=[4, 4], ion_types=["Si", "C"]),
        raw.Cell(
            lattice_vectors=np.array(
                [
                    [4.38006, 0.03167, 0.02296],
                    [-0.03084, 4.37794, -0.01263],
                    [-0.02318, 0.01254, 4.3776],
                ]
            ),
            scale=raw.VaspData(1.0),
        ),
        positions=np.array(
            [
                [6.36000000e-03, 9.98030000e-01, 1.70000000e-04],
                [6.41000000e-03, 4.97910000e-01, 5.00090000e-01],
                [5.06360000e-01, 9.98020000e-01, 4.99980000e-01],
                [5.06360000e-01, 4.98110000e-01, 9.99900000e-01],
                [2.56420000e-01, 2.48070000e-01, 2.50060000e-01],
                [2.56350000e-01, 7.48050000e-01, 7.50050000e-01],
                [7.56380000e-01, 2.48010000e-01, 7.50070000e-01],
                [7.56361937e-01, 7.48009945e-01, 2.46673588e-01],
            ]
        ),
    )
