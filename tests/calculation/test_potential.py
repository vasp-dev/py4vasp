...
def test_is_available_total_only(raw_data):
    ...
    assert potential.is_available("default") is True
    assert potential.is_available("default", method="to_view") is True
    assert potential.is_available("default", method="to_contour") is True
    # nonpolarized total potential has no magnetization -> to_quiver unavailable
    assert potential.is_available("default", method="to_quiver") is False
...
def test_is_available_to_quiver_needs_magnetic(raw_data):
    ...
    assert potential.is_available("default", method="to_quiver") is True
...
def test_is_available_without_potential(raw_data):
    ...
    raw_potential.total_potential = raw.VaspData(None)
    potential = Potential.from_data(raw_potential)
    assert potential.is_available("default") is False
    assert potential.is_available("default", method="to_view") is False
