...
def electronic_minimization(raw_data):
    raw_electronic_minimization = raw_data.electronic_minimization()
    constructor = calculation.electronic_minimization.from_data
    electronic_minimization = constructor(raw_electronic_minimization)
    electronic_minimization.ref = types.SimpleNamespace()
    convergence_data = raw_electronic_minimization.convergence_data
    ...
    is_elmin_converged = [raw_electronic_minimization.is_elmin_converged == [0.0]]
